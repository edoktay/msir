...
%TSIR1   Three-stage iterative refinement in three precisions used within the MSIR function.
%     [x,cged,ferr,nbe,cbe,sirit,gmres_midits,gmresits,switch_iter_mid,switch_iter] = tsir1(A,b,precf,precw,precr,iter_max,rho_thresh,x,xact)

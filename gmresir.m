function x = gmresir(A,b,precf,precw,precr,iter_max,savename)
%GMRESIR   GMRES-based iterative refinement in three precisions.
...
fprintf('GMRES-IR Iteration/Step Count: %s\n',output)
